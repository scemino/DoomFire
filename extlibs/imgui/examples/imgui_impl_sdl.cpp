...
#define MAP_BUTTON(NAV_NO, BUTTON_NO)                                      \
    {                                                                      \
        io.NavInputs[NAV_NO] =                                             \
            (SDL_GameControllerGetButton(game_controller, BUTTON_NO) != 0) \
                ? 1.0f                                                     \
                : 0.0f;                                                    \
    }
#define MAP_ANALOG(NAV_NO, AXIS_NO, V0, V1)                                   \
    {                                                                         \
        float vn =                                                            \
            (float)(SDL_GameControllerGetAxis(game_controller, AXIS_NO) -     \
                    V0) /                                                     \
            (float)(V1 - V0);                                                 \
        if(vn > 1.0f) vn = 1.0f;                                              \
    ...
    MAP_BUTTON(
        ImGuiNavInput_DpadDown, SDL_CONTROLLER_BUTTON_DPAD_DOWN); // D-Pad Down
    MAP_BUTTON(
        ImGuiNavInput_FocusPrev, SDL_CONTROLLER_BUTTON_LEFTSHOULDER); // L1 / LB
    MAP_BUTTON(ImGuiNavInput_FocusNext,
        SDL_CONTROLLER_BUTTON_RIGHTSHOULDER); // R1 / RB
    MAP_BUTTON(
        ImGuiNavInput_TweakSlow, SDL_CONTROLLER_BUTTON_LEFTSHOULDER); // L1 / LB
