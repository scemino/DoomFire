...
int main(int, char**)
{
    ...
    WNDCLASSEX wc = {sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L,
        GetModuleHandle(NULL), NULL, NULL, NULL, NULL, _T("ImGui Example"),
        NULL};
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName,
        _T("Dear ImGui DirectX10 Example"), WS_OVERLAPPEDWINDOW, 100, 100, 1280,
    ...
    while(msg.message != WM_QUIT)
    {
        ...
        g_pd3dDevice->ClearRenderTargetView(
            g_mainRenderTargetView, (float*)&clear_color);
...
bool CreateDeviceD3D(HWND hWnd)
{
    ...
    if(D3D10CreateDeviceAndSwapChain(NULL, D3D10_DRIVER_TYPE_HARDWARE, NULL,
           createDeviceFlags, D3D10_SDK_VERSION, &sd, &g_pSwapChain,
           &g_pd3dDevice) != S_OK)
        return false;
