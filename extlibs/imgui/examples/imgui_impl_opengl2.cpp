...
//  2020-01-23: OpenGL: Explicitly backup, setup and restore GL_TEXTURE_ENV to
//  increase compatibility with legacy OpenGL applications. 2019-04-30: OpenGL:
//  Added support for special ImDrawCallback_ResetRenderState callback to reset
//  render state. 2019-02-11: OpenGL: Projecting clipping rectangles correctly
//  using draw_data->FramebufferScale to allow multi-viewports for retina
//  display. 2018-11-30: Misc: Setting up io.BackendRendererName so it can be
//  displayed in the About Window. 2018-08-03: OpenGL: Disabling/restoring
//  GL_LIGHTING and GL_COLOR_MATERIAL to increase compatibility with legacy
//  OpenGL applications. 2018-06-08: Misc: Extracted imgui_impl_opengl2.cpp/.h
//  away from the old combined GLFW/SDL+OpenGL2 examples. 2018-06-08: OpenGL:
//  Use draw_data->DisplayPos and draw_data->DisplaySize to setup projection
//  matrix and clipping rectangle. 2018-02-16: Misc: Obsoleted the
//  io.RenderDrawListsFn callback and exposed ImGui_ImplOpenGL2_RenderDrawData()
//  in the .h file so you can call it yourself. 2017-09-01: OpenGL: Save and
//  restore current polygon mode. 2016-09-10: OpenGL: Uploading font texture as
//  RGBA32 to increase compatibility with users shaders (not ideal). 2016-09-05:
//  OpenGL: Fixed save and restore of current scissor rectangle.
...
{
    if(!g_FontTexture) ImGui_ImplOpenGL2_CreateDeviceObjects();
}

static void ImGui_ImplOpenGL2_SetupRenderState(
    ImDrawData* draw_data, int fb_width, int fb_height)
{
        ...
        for(int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                    ...
                    clip_rect.z >= 0.0f && clip_rect.w >= 0.0f)
                {
                    ...
                    // Bind texture, Draw
                    glBindTexture(
                        GL_TEXTURE_2D, (GLuint)(intptr_t)pcmd->TextureId);
