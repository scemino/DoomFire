// dear imgui: standalone example application for Emscripten, using SDL2 +
// OpenGL3 This is mostly the same code as the SDL2 + OpenGL3 example, simply
// with the modifications needed to run on Emscripten. It is possible to combine
// both code into a single source file that will compile properly on Desktop and
// using Emscripten. See https://github.com/ocornut/imgui/pull/2492 as an
// example on how to do just that.
//
// If you are new to dear imgui, see examples/README.txt and documentation at
// the top of imgui.cpp. (Emscripten is a C++-to-javascript compiler, used to
// publish executables for the web. See https://emscripten.org/)
...
int main(int, char**)
{
    ...
    g_Window = SDL_CreateWindow("Dear ImGui Emscripten example",
