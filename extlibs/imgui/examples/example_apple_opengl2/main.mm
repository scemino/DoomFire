...
// Forward Mouse/Keyboard events to dear imgui OSX back-end. It returns true
// when imgui is expecting to use the event.
...
- (void)applicationDidFinishLaunching:(NSNotification*)aNotification
{
    ...
    NSOpenGLPixelFormatAttribute attrs[] = {
        NSOpenGLPFADoubleBuffer, NSOpenGLPFADepthSize, 32, 0};

    NSOpenGLPixelFormat* format =
        [[NSOpenGLPixelFormat alloc] initWithAttributes:attrs];
    ImGuiExampleView* view =
        [[ImGuiExampleView alloc] initWithFrame:self.window.frame
                                    pixelFormat:format];
    format = nil;
...
int main(int argc, const char* argv[])
{
    @autoreleasepool
    {
        ...
        ImGuiExampleAppDelegate* delegate =
            [[ImGuiExampleAppDelegate alloc] init];
