...
int main(int, char**)
{
    ...
    HWND hwnd = ::CreateWindow(wc.lpszClassName,
        _T("Dear ImGui DirectX12 Example"), WS_OVERLAPPEDWINDOW, 100, 100, 1280,
    ...
    while(msg.message != WM_QUIT)
    {
        ...
        g_pd3dCommandList->ClearRenderTargetView(
            g_mainRenderTargetDescriptor[backBufferIdx], (float*)&clear_color,
            0, NULL);
    ...
    switch(msg)
    {
        case WM_SIZE:
            if(g_pd3dDevice != NULL && wParam != SIZE_MINIMIZED)
            {
                ...
                CleanupRenderTarget();
                ResizeSwapChain(
                    hWnd, (UINT)LOWORD(lParam), (UINT)HIWORD(lParam));
                CreateRenderTarget();
